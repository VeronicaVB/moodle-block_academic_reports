...
$string['pluginname'] = 'Academic reports';
$string['pluginname_desc'] = 'This plugin depends on DW.';
$string['assigquiz_report'] = 'Report Docs';
$string['attendance_report:addinstance'] = 'Add a new Academic reports block';
$string['attendance_report:myaddinstance'] = 'Add a new Academic reports block to My Moodle page';
...
$string['generatingfile'] = 'Generating compressed file';
